...
\label{chap:results}
% DRAFTING: Restructured to clearly separate full-image (detector) and patch (descriptor) experiments
...
This separation allows us to make clean claims: detector consensus findings come from the full-image pipeline where that is the variable, while descriptor fusion findings come from the patch pipeline where descriptors are the only variable.
...
% ===================================================================
% DRAFTING: New section for patch benchmark with color descriptors
...
This framework predicts that pairing a discriminator with a matcher should yield the best fusion results.
