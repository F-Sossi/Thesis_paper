...
Given the substantial improvement from detector intersection (+18\% over baseline), we conducted additional analysis to understand the underlying mechanism and rule out potential artifacts.

\textbf{Alternative hypotheses ruled out:}
\begin{enumerate}
    \item \textbf{Better repeatability}: Intersection keypoints actually have \textit{lower} repeatability (28.0\%) than scale-controlled keypoints (29.4\%). Paired t-test: $t=-4.28$, $p<0.0001$. The intersection benefit does not come from more stable detection.
