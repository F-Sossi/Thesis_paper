...
For systems requiring high matching accuracy, we recommend filtering to the top 25\% of keypoints by scale. The trade-off is reduced keypoint count (645K vs 2.5M in our experiments), but the quality improvement outweighs the coverage reduction.
...
\todo[inline]{Add actual timing numbers from experiments.db to quantify the overhead}
