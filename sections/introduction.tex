...
\begin{itemize}
    \item \textbf{Traditional descriptors} such as SIFT, SURF, and their variants rely on hand-crafted gradient histograms computed at keypoint locations detected by scale-space analysis.
...
\begin{enumerate}
    ...
    \item \textbf{DescriptorWorkbench Framework.} We develop an open-source evaluation framework implementing the metrics from Bojanic et al. (2020).
\end{enumerate}
