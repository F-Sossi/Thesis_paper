...
\begin{itemize}
    \item \textbf{Traditional descriptors} such as SIFT~\cite{}, SURF, and their variants rely on hand-crafted gradient histograms computed at keypoint locations detected by scale-space analysis.
